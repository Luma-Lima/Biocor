...
public class Agenda implements Serializable {
  ...
  */
  @ManyToOne
  @JoinColumn(name="fk_horario_Escala", nullable = true, referencedColumnName = "id", insertable=true, updatable=true)
  ...
  */
  @ManyToOne
  @JoinColumn(name="fk_medico", nullable = true, referencedColumnName = "id", insertable=true, updatable=true)
  ...
  */
  ...
  @Column(name = "dt_agenda_age", nullable = true, unique = false, insertable=true, updatable=true)
  @CronapiSearchable
  ...
  */
  @ManyToOne
  @JoinColumn(name="fk_local_Plantao", nullable = true, referencedColumnName = "id", insertable=true, updatable=true)
